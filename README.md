...
Nektome — это веб-приложение и Telegram-бот для анонимного общения с AI-собеседниками. Каждый персонаж генерируется с уникальной внешностью, биографией, типом личности, стилем общения и манерой письма. Чат-интерфейс имитирует реальный анонимный чат с индикатором печати, online-счётчиком и RP-режимом.
...
Помимо веб-версии, Nektome работает как Telegram-бот. Полный аналог функционала: генерация персонажей, AI-чат, настройки поиска.
